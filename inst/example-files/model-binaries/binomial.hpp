...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/home/krzysztof/packages/stannis/inst/example-files/model-binaries/binomial.stan");
    reader.add_event(27, 27, "end", "/home/krzysztof/packages/stannis/inst/example-files/model-binaries/binomial.stan");
    return reader;
}
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            for (int i = 1; i <= n_obs; ++i) {
                ...
                if (as_bool(logical_gt(get_base1(y,i,"y",1),N))) {
                    current_statement_begin__ = 10;
                    std::stringstream errmsg_stream__;
                    errmsg_stream__ << "Can\'t win if you don\'t try.";
